...
<div class="container my-4">
    <section class="p-md-3 mx-md-5 my-8 text-lg-left">
        <h2 class="text-center font-weight-bold my-4 pb-1">Our guiding Team</h2>
        <p class="text-center lead mb-5 pb-2 text-muted">Meet our faculty guiding and organising team.</p>
        <div class="row">
            ...
            <div class="col-lg-4 col-sm-6 mb-5">
                <div class="row d-flex align-items-center">
                    <div class="col-5 avatar w-100 white d-flex justify-content-center align-items-center">
                        <img src="https://mdbootstrap.com/img/Photos/Avatars/img%20(7).jpg" class="img-fluid rounded-circle z-depth-1" />
                    </div>
                    <div class="col-7">
            ...
            <div class="col-lg-4 col-sm-6 mb-5">
                <div class="row d-flex align-items-center">
                    <div class="col-5 avatar w-100 white d-flex justify-content-center align-items-center">
                        <img src="https://mdbootstrap.com/img/Photos/Avatars/img%20(25).jpg" class="img-fluid rounded-circle z-depth-1" />
                    </div>
                    <div class="col-7">
            ...
            <div class="col-lg-4 col-sm-6 mb-5">
                <div class="row d-flex align-items-center">
                    <div class="col-5 avatar w-100 white d-flex justify-content-center align-items-center">
                        <img src="https://mdbootstrap.com/img/Photos/Avatars/img%20(19).jpg" class="img-fluid rounded-circle z-depth-1" />
                    </div>
                    <div class="col-7">
